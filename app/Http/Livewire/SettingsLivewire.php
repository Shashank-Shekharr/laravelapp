...
class SettingsLivewire extends BaseLivewireComponent
{
    ...
    public function render()
    {
        ...
        }else if( $this->showMeeting ){
            return view('livewire.settings.meeting-settings');
        }else if( $this->showPrivacy ){
            return view('livewire.settings.privacy-policy');
        }else if( $this->showAndroidAdmob ){
            return view('livewire.settings.android-admob');
        }else if( $this->showiOSAdmob ){
            return view('livewire.settings.ios-admob');
        }else{
